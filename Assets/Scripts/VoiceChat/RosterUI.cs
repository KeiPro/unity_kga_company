...
{
    [SerializeField] private GameObject _rosterItemPrefab;
    ...
    {
        _contentRt.sizeDelta = new Vector2(0, m_RosterObjects[channelName].Count * 50);
    }
    ...
    {
        GameObject newRosterObject = GameObject.Instantiate(_rosterItemPrefab, _contentRt.transform);
